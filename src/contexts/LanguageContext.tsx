...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'story.timeline.title': 'Our Journey',
    'story.timeline.2020': 'First liturgy celebrated in a tent during the pandemic',
    'story.timeline.2022': 'Community grows in temporary location',
    'story.timeline.2023': 'Mission formally established with Archbishop\'s blessing',
    'story.timeline.2024': 'Building fund launched',
    'story.timeline.2025': 'Goal: Acquire land (6-8 acres)',
    'story.timeline.future': 'Permanent church & first Russian Orthodox cemetery in Chicagoland',
  ...
  ru: {
    ...
    'story.timeline.title': 'Наш путь',
    'story.timeline.2020': 'Первая литургия в палатке во время пандемии',
    'story.timeline.2022': 'Рост общины во временном помещении',
    'story.timeline.2023': 'Миссия официально учреждена с благословения Архиепископа',
    'story.timeline.2024': 'Запущен фонд строительства',
    'story.timeline.2025': 'Цель: приобретение земли (2,5-3,5 га)',
    'story.timeline.future': 'Постоянный храм и первое русское православное кладбище в Чикаголенде',
    ...
    'contact.address': 'Почтовый адрес',
